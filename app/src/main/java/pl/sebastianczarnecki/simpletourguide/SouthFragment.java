...
public class SouthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tourguideEast.add(new East("Crossroads", R.drawable.south_3_placnarozdrozu, getString(R.string.south_1)));
        tourguideEast.add(new East("National Library", R.drawable.south_4_bibliotekanarodowa, getString(R.string.south_2) ));
        tourguideEast.add(new East("X", R.drawable.south_6_x, getString(R.string.south_3)));
